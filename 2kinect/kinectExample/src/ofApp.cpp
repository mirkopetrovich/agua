...
void ofApp::update() {
	...
	if(kinect.isFrameNew()) {
		...
		if(bThreshWithOpenCV) {
            ...
            grayThreshNear2.threshold(nearThreshold, true);
...
void ofApp::draw() {
	...
	if(bDrawPointCloud) {
		...
		grayImage.draw(0, 0 ,1920, 1200);
		//ontourFinder.draw(10, 320, 400, 300);
		
#ifdef USE_TWO_KINECTS
		grayImage2.draw(1921, 0, 1920, 1200);
#endif
	}
	...
	ofDrawBitmapString(reportStream.str(), 20, 0);
